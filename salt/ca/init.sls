...
/etc/pki/{{ cert }}.crt:
  x509.certificate_managed:
    - signing_private_key: /etc/pki/{{ cert }}.key
    - CN: CaaSP Autogenerated {{ cert }}
...
mine.send {{ cert }}:
  module.wait:
    ...
    - kwargs:
        ...
        glob_path: /etc/pki/{{ cert }}.crt
    - watch:
        - x509: /etc/pki/{{ cert }}.crt
{% endfor %}